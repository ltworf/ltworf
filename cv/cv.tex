...
\cvitem{Languages}{ In order of experience:
    Python, C, C++, nesC, Java, PHP, Javascript
    }
...
\cventry{2014-}
    ...
    {}
    {
        The company sells integrated devices to watch live programs or download on demand.
        \newline
        The C++ team provides a scalable version of the backend API.
        \newline
        My role includes the integration of Elasticsearch within the API, to provide the devices with full text search and filtering.
    }
